...
namespace ConfectionaryBusinessLogic.OfficePackage.Implements
{
    public class SaveToExcel : AbstractSaveToExcel
    {
        ...
        private static void CreateStyles(WorkbookPart workbookpart)
        {
            ...
            var cellFormatFont = new CellFormat() { NumberFormatId = 0U, FontId = 0U, 
                FillId = 0U, BorderId = 0U, FormatId = 0U, ApplyFont = true };
            var cellFormatFontAndBorder = new CellFormat() { NumberFormatId = 0U, FontId
                = 0U, BorderId = 1U, FormatId = 0U, ApplyFont = true, ApplyBorder = true };
            var cellFormatTitle = new CellFormat() { NumberFormatId = 0U, FontId = 1U, 
                FillId = 0U, BorderId = 0U, FormatId = 0U, Alignment = new Alignment() 
        ...
        protected override void InsertCellInWorksheet(ExcelCellParameters excelParams)
        {
           ...
           excelParams.CellReference).Any())
            ...
            cell.CellValue = new CellValue((shareStringPart.SharedStringTable.
